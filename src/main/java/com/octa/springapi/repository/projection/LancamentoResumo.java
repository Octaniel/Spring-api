package com.octa.springapi.repository.projection;

import com.octa.springapi.model.TipoDeLancamento;
...
public class LancamentoResumo {
    ...
    public LancamentoResumo(Long id, String descricao, LocalDate dataVencimento, LocalDate dataPagamento,
                            BigDecimal valor, TipoDeLancamento tipo, String categoria, String pessoa) {
        this.id = id;
